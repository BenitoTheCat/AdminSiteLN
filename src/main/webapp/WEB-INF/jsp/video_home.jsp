<%-- 
    Document   : video_home
    Created on : May 17, 2015, 4:45:45 PM
    Author     : Luxo
--%>
        ...
        <div id="wrapper">
            ...
            <div id="content_wrapper">
                ...
                <div id="primary_content">
                    ...
                    <a href="<c:url value="/createVideo"/>" type="button" class="btn btn-primary" >Subir Video</a>
                    ...
                    <br>
                        <br>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <c:forEach var="infografias" items="${list_videos}" varStatus="docNum">
                                        <tr>
                                            ...
                                            <td>
                                                <c:choose>
                                                    <c:when test="${infografias.publicado==1}">
                                                        <a href="javascript:setDespublicar('${infografias.idVideo}')" type="button" class="btn btn-success" >Publicado</a>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <a href="javascript:setPublicar('${infografias.idVideo}')" type="button" class="btn btn-info" >Edición </a>
                                                    </c:otherwise>
                                                </c:choose>
                                            </td>
                                            <td>
